...
class TestDeleteSource:
    ...
    def test_removes_config_entry(self, tmp_path, db_with_pipeline_tables, src_cfg_path):
        from proto_pipe.cli.commands.delete import delete_source

        runner = CliRunner()
        with patch("proto_pipe.cli.commands.delete.config_path_or_override",
    ...
    def test_unknown_table_shows_error(self, tmp_path, db_with_pipeline_tables, src_cfg_path):
        from proto_pipe.cli.commands.delete import delete_source
...
class TestViewTable:
    def test_shows_rows(self, tmp_path, db_with_pipeline_tables):
        ...
        runner = CliRunner()
        with patch("proto_pipe.cli.commands.view.config_path_or_override",
                   return_value=db_with_pipeline_tables), \
             patch("proto_pipe.cli.commands.view._show_or_export"), \
             patch("proto_pipe.io.config.load_settings",
...
class TestViewSource:
    ...
    def test_unconfigured_source_shows_error(self, tmp_path, db_with_pipeline_tables,
                                              src_cfg_path):
        from proto_pipe.cli.commands.view import view_source
...
class TestViewReport:
    ...
    def test_shows_rows(self, tmp_path, db_with_pipeline_tables, src_cfg_path, rep_cfg_path):
    ...
    def test_unknown_report_shows_error(self, tmp_path, db_with_pipeline_tables,
                                         src_cfg_path, rep_cfg_path):
        from proto_pipe.cli.commands.view import view_report
...
class TestViewDeliverable:
    ...
    def test_missing_sql_shows_error(self, tmp_path, db_with_pipeline_tables, del_cfg_path):
...
class TestFlaggedClear:
    ...
    def test_clear_removes_rows(self, tmp_path, db_with_pipeline_tables, src_cfg_path):
        ...
        runner = CliRunner()
        with patch("proto_pipe.cli.flagged.config_path_or_override",
                   side_effect=self._cfg(db_with_pipeline_tables, src_cfg_path)):
    ...
    def test_clear_empty_shows_message(self, tmp_path, db_with_pipeline_tables, src_cfg_path):
        from proto_pipe.cli.flagged import flagged_clear
